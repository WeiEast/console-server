...
server_application="/dashu/application/console-server"
...
# 4.upload
echo "upload web/target/console-server-web-1.0.0-SNAPSHOT.jar ..."
sshpass -p dashu0701 scp  web/target/console-server-web-1.0.0-SNAPSHOT.jar root@$server_ip:$server_application
