...
import com.treefinance.saas.management.console.web.auth.exception.CallbackEncryptException;
import com.treefinance.saas.management.console.web.auth.exception.CryptorException;
...
public class CallbackSecureHandler {
    ...
    public String encrypt(Object data, String publicKey) throws CallbackEncryptException {
        ...
        String encryptedData = CallbackSecureHandler.Helper.encryptResult(data, publicKey);
    ...
    public String decrypt(Object data, String privateKey) throws CallbackEncryptException {
        ...
        String decryptedData = CallbackSecureHandler.Helper.decryptResult(data, privateKey);
