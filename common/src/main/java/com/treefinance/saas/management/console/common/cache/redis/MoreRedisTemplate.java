...
package com.treefinance.saas.management.console.common.cache.redis;
...
public class MoreRedisTemplate extends RedisTemplate<String, Object> implements
    ...
    public Boolean acquireLock(final String lock, long expired) {
        ...
        if (acquired) {
            ...
            long oldValue = Long.valueOf(String.valueOf(this.get(lock)));
            if (oldValue < System.currentTimeMillis()) {
                String getValue = String.valueOf(this.getSet(lock, String.valueOf(value)));
