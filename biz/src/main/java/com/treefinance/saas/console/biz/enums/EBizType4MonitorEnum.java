 ...
 */
public enum EBizType4MonitorEnum {
    ...
    EBizType4MonitorEnum(String text, Byte code, String name, Byte monitorCode, String monitorName) {
        this.code = code;
        this.text = text;
        this.name = name;
    ...
    public static Byte getMonitorCode(Byte code) {
        for (EBizType4MonitorEnum item : EBizType4MonitorEnum.values()) {
